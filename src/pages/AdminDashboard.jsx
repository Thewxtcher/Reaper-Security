...
import {
  ...
  AlertTriangle, BarChart2, Lock, Trash2, Settings, Server,
  Database, FileText, Cpu, HardDrive, Globe, Wifi, Clock,
  TrendingUp, UserCheck, Key, Archive, RefreshCw, Bug,
  CheckCircle, XCircle, Zap, Monitor, Package, Terminal,
  ChevronRight, Home, Bell, Wrench, Bot
} from 'lucide-react';
...
const NAV_ITEMS = [
  ...
  { id: 'messages', label: 'Messages', icon: Bot },
    ...
    <div className="min-h-screen flex bg-[#0a0a0a]">
      ...
      <div className="w-56 flex-shrink-0 bg-[#111] border-r border-white/5 flex flex-col fixed top-16 bottom-0 overflow-y-auto z-20">
        <div className="p-4 border-b border-white/5">
          ...
          {isOwner && (
            <span className="text-xs text-red-400 font-medium">👑 Owner</span>
          )}
        </div>
